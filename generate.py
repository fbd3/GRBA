...
def test_moco(train_loader, model, opt):
    ...
    # data has been changed if it should be 
    emb_list = []
...
def main(args_test):
    ...
    if args_test.dataset in GRAPH_CLASSIFICATION_DSETS:
        # 下流任务 trigger 注入
        train_dataset = GraphClassificationDataset( # GraphDataset -> NodeClassificationDataset -> GraphClassificationDataset -> GraphClassificationDatasetLabeled
